...
gcc -c simulation.c
gcc simulation.o ticket_machine.o ticket_office.o customer_support.o security_check.o ticket_gate.o rngs.o utility_function.o -o simulation -lm
./simulation 10 5 2 3 15 1
rm simulation
rm simulation.o
rm ticket_machine.o
rm ticket_office.o
